...
res = []
def transfer_parameter_value(doc,Transaction,allElements,paramA,paramB):
	with Transaction(doc, "Transfer Data") as ttd:
		...
		for elem in allElements:
			try:
				...
				valueA = None
				if elemParamA.StorageType == StorageType.String and elemParamB.StorageType == StorageType.String:
					valueA = elemParamA.AsString()
					
				if elemParamA.StorageType == StorageType.Double and not elemParamA.DisplayUnitType == DisplayUnitType.DUT_DECIMAL_DEGREES and not elemParamA.DisplayUnitType == DisplayUnitType.DUT_SLOPE_DEGREES:
					if float(elemParamA.AsDouble()) and elemParamB.StorageType == StorageType.Double: 
